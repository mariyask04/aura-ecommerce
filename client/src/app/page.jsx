  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply opacity-30 animate-pulse" />
        <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply opacity-30 animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-violet-100 rounded-full mix-blend-multiply opacity-20 animate-pulse delay-500" />
      </div>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-blue-100/60 border border-white/60 p-8"
        >
          {/* Header */}
          <motion.div
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            >
              <motion.button
                ...
                className={`w-full py-3 rounded-xl font-semibold text-sm text-white tracking-wide transition-all duration-200 relative overflow-hidden shadow-lg shadow-blue-200 ${loading
          ...
          >
            ...
            <motion.span
              ...
              whileTap={{ scale: 0.95 }}
              className="text-blue-500 font-semibold cursor-pointer hover:text-indigo-600 transition-colors duration-150 inline-block"
            >
              Create one
            </motion.span>
          </motion.p>
